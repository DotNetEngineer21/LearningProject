...
{
    public class GoogleAuthenticatorProvider : CoreOSRServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("CoreOSR", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
